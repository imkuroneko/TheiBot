...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('twitch')
        .setDescription('Gestionar canales de Twitch')
        .addSubcommand(sub => sub
            .setName('add')
            .setDescription('Registrar un canal de Twitch')
            .addStringOption(option => option
                .setName('canal_de_twitch')
                .setDescription('El usuario de Twitch')
                .setRequired(true)
                .setMinLength(1)
                .setMaxLength(25)
            )
            .addChannelOption(option => option
                ...
                .setDescription('Canal para los anuncios')
                .setRequired(true)
            ...
            .addStringOption(option => option
                .setName('color_hex')
                .setDescription('Color en hexadecimal para el embed')
                .setRequired(true)
                .setMinLength(6)
                .setMaxLength(6)
            )
        ...
        .addSubcommand(sub => sub
            .setName('del')
            .setDescription('Eliminar un canal de Twitch registrado')
            .addStringOption(option => option
                .setName('canal_de_twitch')
                .setDescription('El usuario de Twitch')
                .setRequired(true)
    ...
    async execute(interaction) {
        ...
        try {
            if (sub === 'add') {
                ...
                if (!authData) {
                    return interaction.reply({ content: '❌ No se pudo obtener el token de Twitch.', ephemeral: true });
                }
            ...
            if (sub === 'del') {
                ...
                return interaction.reply({ content: '🙆🏻‍♀️ He eliminado al streamer de mi base de datos hooman...', ephemeral: true });
            }
        } catch (error) {
            console.error('[interaction:slashcmd:twitch]', error.message);
        }
    }
};
